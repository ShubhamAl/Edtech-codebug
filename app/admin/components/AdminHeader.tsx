      ...
      >
        ...
        <div className="flex items-center gap-5">
          <button
            ...
            className={`lg:hidden p-2.5 rounded-xl bg-[#8E97FD] ${blackBorder} shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] dark:shadow-[3px_3px_0px_0px_rgba(255,255,255,1)] active:shadow-none active:translate-x-[2px] active:translate-y-[2px] transition-all`}
          >
          ...
          <div className="relative group flex items-center gap-2">
            ...
            <div className="h-2 w-2 rounded-full bg-[#FF6AC1] border-2 border-black dark:border-white" />
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative" ref={profileRef}>
            ...
            >
              <div className={`h-9 w-9 bg-violet-500 rounded-lg ${blackBorder} flex items-center justify-center text-white`}>
              ...
              <div className="hidden md:flex flex-col items-start leading-none">
                ...
                <span className="text-[9px] font-black text-[#A3E635] dark:text-violet-500 uppercase mt-0.5">Master</span>
              </div>
              ...
              {isProfileOpen && (
                ...
                >
                  <div className={`flex items-center gap-3 p-3 mb-3 bg-[#F9F4F1] dark:bg-zinc-800 rounded-xl ${blackBorder}`}>
                    <div className="h-10 w-10 rounded-lg bg-violet-500 border-2 border-black flex items-center justify-center">
                    ...
                    <div className="flex flex-col overflow-hidden">
                      ...
                      <p className="text-[10px] font-bold text-violet-500 uppercase">Master Admin</p>
                    </div>
                  </div>
